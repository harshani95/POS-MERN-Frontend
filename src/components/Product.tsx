...
const Product: React.FC = () => {
  ...
  const updateProduct = async () => {
    try {
      await AxiosInstance.put(
        "http://localhost:3000/api/v1/products/update/" + selectedProductId,
        {
          name: updateName,
  ...
  const findAllProducts = async () => {
    const response = await AxiosInstance.get(
      "/products/find-all?searchText=&page=1&size=10"
    );
  ...
  const searchProduct = async (event: { preventDefault: () => void }) => {
    ...
    try {
      const response = await AxiosInstance.get(
        `/products/find-all?searchText=${searchText}&page=1&size=10`
      );
      setProducts(response.data);
    } catch (error) {
  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-6">
            <button className="btn btn-primary col-6" onClick={saveProduct}>
              Save Product
            </button>
          </div>
        </div>
        ...
        <div className="p-4">
          ...
          <div className="col-12">
            ...
            <button
              ...
              onClick={() => setLoadModalState(false)}
            >
              Close Modal
            </button>
          </div>
            ...
            <div className="modal-content">
              ...
              <div className="modal-footer">
                <button
                  ...
                  onClick={() => setViewModalState(false)}
                >
                  Close
                </button>
              </div>
